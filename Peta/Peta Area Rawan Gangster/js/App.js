...
// Membuat fungsi untuk menentukan marker (Kejadian Tahun 2024)
function pointToLayerkejadian2024(feature, latlng) {
...
// Memuat GeoJSON ke peta (Kejadian Tahun 2024)
L.geoJSON(data_kejadian_2024, {
    pointToLayer: pointToLayerkejadian2024,
});

// Data Kejadian Tahun 2023
...
// Membuat fungsi untuk menentukan marker (Kejadian Tahun 2023)
function pointToLayerkejadian2023(feature, latlng) {
    var prop = feature.properties;
...
// Memuat GeoJSON ke peta (Kejadian Tahun 2023)
L.geoJSON(data_kejadian_2023, {
    pointToLayer: pointToLayerkejadian2023,
});

// Data Kejadian Tahun 2022
var crashIcon3 = L.icon({
...
// Membuat fungsi untuk menentukan marker (Kejadian Tahun 2022)
function pointToLayerkejadian2022(feature, latlng) {
    var prop = feature.properties;
    ...
    return L.marker(latlng, { icon: crashIcon3 }).bindPopup(popupContent);
}

// Memuat GeoJSON ke peta (Kejadian Tahun 2022)
L.geoJSON(data_kejadian_2022, {
    pointToLayer: pointToLayerkejadian2022,
});

// Data Area Rawan gangster Tinggi
// Membuat fungsi pop-up Area Rawan gangster
...
// Buat layer-group untuk masing-masing tahun kejadian gangster
var kejadian2024Layer = L.geoJSON(data_kejadian_2024, {
    pointToLayer: pointToLayerkejadian2024,
});

var kejadian2023Layer = L.geoJSON(data_kejadian_2023, {
    pointToLayer: pointToLayerkejadian2023,
});

var kejadian2022Layer = L.geoJSON(data_kejadian_2022, {
    pointToLayer: pointToLayerkejadian2022,
});
...
var overlayLayers = {
    ...
    "Data Titik Kejadian 2024": kejadian2024Layer,
    "Data Titik Kejadian 2023": kejadian2023Layer,
    "Data Titik Kejadian 2022": kejadian2022Layer,
    "Area Rawan Gangster": area_rawan
};
    ...
    legends: [ 
        {
            ...
            label: "Titik Kejadian tahun 2024",
            type: "image",
            url: "./Assets/img/crash-marker.png",
        },{
            label: "Titik Kejadian tahun 2023",
            type: "image",
            url: "./Assets/img/crash-marker-blue.png",
        },{
            label: "Titik Kejadian tahun 2022",
            type: "image",
            url: "./Assets/img/crash-marker-yellow.png",
        },{   
            label: "Area Kejadian Gengster",
            type: "image",
...
function onLocationFound(e) {
    ...
    // Periksa apakah lokasi pengguna berada dalam area rawan gangster
    ...
    if (!("Notification" in window)) {
        ...
        // Jika pengguna berada dalam area rawan gangster, tampilkan notifikasi dan pop-up
        if (userWithinArea && Notification.permission === "granted") {
            showNotification("Saat ini anda sedang berada dalam Area Rawan Gangster");
            showPopup("Saat ini anda sedang berada dalam Area Rawan Gangster");
...
const left = '<div class="header"><img src="./Assets/img/home.jpg" alt="Image" style="width: 15px; height: 13px;"><b><a href="https://sentinel-beta.vercel.app"> Home</b></a></div>';
let contents = `
    <div class="content">
        <div class="title"><img src="./Assets/img/maps.jpg" alt="Image" style="width: 11px; height: 11px;"><a href="https://sentinel-beta.vercel.app/Peta/Peta%20Area%20Rawan%20Gangster/index.html"> Peta Area Rawan Gangster</a></div>
        <div class="title"><img src="./Assets/img/maps.jpg" alt="Image" style="width: 11px; height: 11px;"><a href="https://sentinel-beta.vercel.app/Peta/Peta%20Markas%20Gangster"> Peta Markas Gangster</a></div>
        <div class="title"><img src="./Assets/img/maps.jpg" alt="Image" style="width: 11px; height: 11px;"><a href="https://sentinel-beta.vercel.app/Peta/Peta%20NKDE/index.html"> Peta NKDE</a></div>
    </div>`;
