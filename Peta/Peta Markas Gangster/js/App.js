...
// Membuat fungsi untuk menentukan marker (Gangster tahun 2024)
function pointToLayerganster2024(feature, latlng) {
...
// Memuat GeoJSON ke peta (Gangster tahun 2024)
L.geoJSON(data_gangster_2024, {
    pointToLayer: pointToLayerganster2024,
});
...
var gangster2024Layer = L.geoJSON(data_gangster_2024, {
    pointToLayer: pointToLayerganster2024,
});
...
var overlayLayers = {
    ...
    "Data Gangster 2024": gangster2024Layer,
    ...
    legends: [ 
        {
            ...
            label: "Kejadian gangster tahun 2024",
            type: "image",
            url: "./Assets/img/crash-marker.png",
        },{
            label: "Area Rawan Gangster",
            type: "image",
